                    ...
                    <div class="header-bottom-row">
                        ...
                        <nav class="header-nav">
                            <ul>
                                ...
                                <li><a href="<?php echo e(route('products.index')); ?>">Каталог</a></li>
                                <li><a href="<?php echo e(route('login')); ?>">Войти</a></li>
                                <li><a href="<?php echo e(route('registration')); ?>">Регистрация</a></li>
                                <li>
                                    <a href="<?php echo e(route('cart.index')); ?>">
                                      <img src="<?php echo e(asset('Assets/cart.png')); ?>" alt="cart" width="30px" class="d-inline-block align-text-top">
                                    </a>
                                </li>
                            </ul>
                        </nav>
...
<?php /**PATH C:\openserver\domains\Varov\music_house\resources\views/layout.blade.php ENDPATH**/ ?>